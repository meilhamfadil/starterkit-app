package id.co.lib.mvvm.data

import id.co.lib.ui.ComponentLiveDao

/**
 * Created by Kudzoza
 * on 18/01/2021
 **/
class LiveList<T>(private val defValue: ArrayList<T> = arrayListOf()) : ComponentLiveDao<ArrayList<T>>(defValue), List<T> {
    ...
    override fun get(index: Int) = arrayList[index]
